  ...
  return (
    <div>
      ...
      <main className="wiki-container" style={{ marginTop: '80px', maxWidth: '400px', textAlign: 'center' }}>
        ...
        <a href="/api/auth/signin?provider=google" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', padding: '12px 24px', border: '1px solid #a2a9b1', background: '#ffffff', cursor: 'pointer', fontSize: '16px', color: '#202122', textDecoration: 'none', width: '100%' }}>
